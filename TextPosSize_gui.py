...
class TextPosSize_gui ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.ref_width = wx.SpinCtrlDouble( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 1000, 1.0, 0.1 )
        ref_value_box.Add( self.ref_width, 0, wx.EXPAND, 5 )
        self.ref_height = wx.SpinCtrlDouble( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 1000, 1.0, 0.1 )
        ...
        self.value_width = wx.SpinCtrlDouble( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 1000, 1.0, 0.1 )
        value_value_box.Add( self.value_width, 0, wx.EXPAND, 5 )
        self.value_height = wx.SpinCtrlDouble( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 1000, 1.0, 0.1 )
        ...
        self.other_width = wx.SpinCtrlDouble( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 1000, 1.0, 0.1 )
        other_value_box.Add( self.other_width, 0, wx.EXPAND, 5 )
        self.other_height = wx.SpinCtrlDouble( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 1000, 1.0, 0.1 )
